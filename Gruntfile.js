...
module.exports = function (grunt) {
  ...
  grunt.registerTask(
    ...
    npmReactNativeTasks.buildRelease
  );
  ...
  grunt.registerTask(
    ...
    npmReactAddonsTasks.buildReleases
  );
  ...
  grunt.registerTask(
    ...
    npmReactTestRendererTasks.buildRelease
  );
  grunt.registerTask(
    "npm-react-test:pack",
    npmReactTestRendererTasks.packRelease
  );
  ...
  grunt.registerTask("build:addons", ["build-modules", "browserify:addons"]);
